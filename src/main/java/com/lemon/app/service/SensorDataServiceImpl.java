...
@Service
public class SensorDataServiceImpl implements SensorDataService<SensorData> {
    ...
    private final MqttPublishingServiceImpl publisher;
    ...
    public SensorDataServiceImpl(
            ...
            MqttPublishingServiceImpl publisher
    ) {
        ...
        this.publisher = Objects.requireNonNull(publisher, "MqttPublishingServiceImpl is required");
    }

    @Override
    public void process(@Validated SensorData data) throws NumberFormatException {
        try {
